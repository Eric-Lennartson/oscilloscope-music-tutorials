...
"groups": [
	{
		...
		{OsciVectorPluginLivecoding:
			"uid":"8ZwadWVpmr0VCLyiG0hd0rSOGvZkUs8L"
			"enabled":1
			"expanded":1
			"title":"Livecoding"
			"bg":63,89,127,255
...
vec3 gen(float t) 
{
	...
	float bright_t = pow(t, bright);
	bright_t = mod1(bright_t + offset);
...
"timeline": {
	...
	"clips": {
		"clips": [ {"uid":"6e4a76OY2xrAk4A2lBwwoKcJFKTa8WvU" "enabled":0 "expanded":1 "title":"Clip" "bg":13,193,31,255 "use abs bpm":0 "absolute bpm":120 "relative bpm":1 "arrangement": { "loop": { "loopStart":0 "loopEnd":8 } "quartersPerMeasure":4 "duration":8 "tracks": [ ] "gridsize":4 } "grid_x":0 "grid_y":0 }]
	}
	"split":0.2
}
"useMidiClock":0
